...
def get_player_name(players, player_id):
    aliases = players[player_id]["aliases"]
    return aliases[0] if aliases else f"Player {player_id}"
...
def delete_player(connection, player_id):
    ...
    alias = get_player_name(players, player_id)
...
def main():
    ...
    try:
        ...
        print(
            ...
            "in which they participated, including the match ratings for "
